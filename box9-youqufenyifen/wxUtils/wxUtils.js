...
const BASE = "https://xcx.getboolean.com/source/plugin/fenzu/";
const URL = {
...
const APPINFO = {
  'appid': 'wxb5589262c3c9b585', 
  'appsecret': '48e7d41fab3b545abf39fbf3d2388f56'
}
...
let wxUtils = {
  ...
  getOpenId(success = noop, fail = noop, complete = noop){
    ...
    if (openId){
      ...
      wx.login({
        success : (res)=>{
          this.request('getOpenId', { code: res.code, appid: APPINFO.appid, appsecret:APPINFO.appsecret},
            (res)=>{
              if(res.openid){
